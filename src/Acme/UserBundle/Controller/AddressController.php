...
class AddressController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AcmeUserBundle:Address')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AcmeUserBundle:Address')->find($id);
     ...
     * @Method("post")
     * @Template("AcmeUserBundle:Address:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("AcmeUserBundle:Address:edit.html.twig")
     */
