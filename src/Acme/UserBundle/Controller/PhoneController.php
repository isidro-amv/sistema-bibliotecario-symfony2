...
class PhoneController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AcmeUserBundle:Phone')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AcmeUserBundle:Phone')->find($id);
     ...
     * @Method("post")
     * @Template("AcmeUserBundle:Phone:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("AcmeUserBundle:Phone:edit.html.twig")
     */
