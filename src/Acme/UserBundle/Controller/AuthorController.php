...
class AuthorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AcmeUserBundle:Author')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AcmeUserBundle:Author')->find($id);
     ...
     * @Method("post")
     * @Template("AcmeUserBundle:Author:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("AcmeUserBundle:Author:edit.html.twig")
     */
